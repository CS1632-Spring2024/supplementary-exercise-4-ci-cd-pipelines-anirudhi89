...
public class RentACatIntegrationTest {
	 ...
	 */
	@Test
	public void testGetCatNumCats3() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		r.addCat(c1);
		r.addCat(c2);
		r.addCat(c3);
		Method method;
	...
	public void testListCatsNumCats3() {
		...
		r.addCat(c2);
		r.addCat(c3);
		assertEquals("ID 1. Jennyanydots" + newline + "ID 2. Old Deuteronomy" + newline + "ID 3. Mistoffelees" + newline,
				r.listCats());
	}
