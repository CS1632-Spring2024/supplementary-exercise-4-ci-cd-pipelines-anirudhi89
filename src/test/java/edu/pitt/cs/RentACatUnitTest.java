...
public class RentACatUnitTest {
	...
	public void testGetCatNumCats3() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		r.getClass().getDeclaredMethod("addCat", Cat.class).invoke(r, c1);
		r.getClass().getDeclaredMethod("addCat", Cat.class).invoke(r, c2);
		r.getClass().getDeclaredMethod("addCat", Cat.class).invoke(r, c3);
		Method method = r.getClass().getDeclaredMethod("getCat", int.class);
		method.setAccessible(true);
		Object ret = method.invoke(r, 2);
		assertNotNull(ret);
	...
	public void testRentCatFailureNumCats3() throws IOException {
		...
		boolean isCat2Rented = c2.getRented();
